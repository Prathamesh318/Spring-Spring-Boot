...
<body>
	...
	<%if(P!=null) {%>
		<div class="content">
	<h1><%out.println("Product ID :"+P.getId()); %></h1>
	<h1><%out.println("Product Name :"+P.getName()); %></h1>
	<h1><%out.println("Product Company :"+P.getCompany()); %></h1>
	<h1><%out.println("Product Quantity :"+P.getQuantity()); %></h1>
		</div>
	<%} %>
